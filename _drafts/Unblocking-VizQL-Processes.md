...
# How a view of a dashboard works
# Reason for large vizql work
# Cache (RAM), Workbook (Optimize), Datasize (Strategies), Dataspeed (Extract or optimize)
# More cores
# Link to Lumberjack post
